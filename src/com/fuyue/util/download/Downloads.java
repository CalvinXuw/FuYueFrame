...
public final class Downloads {
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS = Constants.PACKAGENAME
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS_ADVANCED = Constants.PACKAGENAME
	 ...
	 * @hide
	 */
	public static final String PERMISSION_CACHE = Constants.PACKAGENAME
	 ...
	 * @hide
	 */
	public static final String PERMISSION_SEND_INTENTS = Constants.PACKAGENAME
	...
	public static final Uri CONTENT_URI = Uri.parse("content://"
			+ DownloadProvider.AUTHORITY + "/my_downloads");
	 ...
	 * @hide
	 */
	public static final String ACTION_DOWNLOAD_COMPLETED = Constants.PACKAGENAME
			+ ".intent.action.DOWNLOAD_COMPLETED";
	 ...
	 * asociated with this downloaded file.
	 * <P>
	 * Type: BOOLEAN
	 * </P>
	 * <P>
	...
	/**
	 * This download will be saved to the download manager's private partition
	 * and will be purged as necessary to make space. This is for private files
	 * (similar to CACHE_PARTITION) that aren't deleted immediately after they
	 * are used, and are kept around by the download manager as long as space is
	 * available.
	 * 
	 * @hide
	 */
	...
	/**
	 * This download will be saved to the download manager's private partition,
	 * as with DESTINATION_CACHE_PARTITION, but the download will not proceed if
	 * the user is on a roaming data connection.
	 * 
	 * @hide
	 */
	 ...
	 * @param status
	 *            status
	 * @return Returns whether the download has completed (either with success
	 *         or error).
	 */
	public static boolean isStatusCompleted(int status) {
		return (status >= 200 && status < 300)
				|| (status >= 400 && status < 600); // SUPPRESS CHECKSTYLE
	}
	...
	public static final class Impl implements BaseColumns {
		 ...
		 */
		public static final String PERMISSION_ACCESS_ALL = Constants.PACKAGENAME
		 ...
		 */
		public static final String PERMISSION_CACHE_NON_PURGEABLE = Constants.PACKAGENAME
		 ...
		 * being shown.
		 */
		public static final String PERMISSION_NO_NOTIFICATION = Constants.PACKAGENAME
		...
		public static final Uri ALL_DOWNLOADS_CONTENT_URI = Uri
				.parse("content://" + DownloadProvider.AUTHORITY
						+ "/all_downloads");
		 ...
		 * data. 注意：如果在开启下载前，指定了下载文件类型，则在下载过程中，如果与指定类型不一致，则会下载失败。
		 * 如果不指定下载类型，则不处理，会使用response Header中的mimetype.
		 * <P>
		 * Type: TEXT
		 * </P>
		 * <P>
	 ...
	 * 
	 * @param mode
	 *            {@link DestinationMode#AUTO AUTO},
	 ...
	 * 
	 * @param dir
	 *            自定义下载目录，只有当下载模式为{@link DestinationMode#CUSTOM CUSTOM}
	 *            时才有效，其他模式可设为null.
	 */
