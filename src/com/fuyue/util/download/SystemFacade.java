...
interface SystemFacade {
	...
	/**
	 * Network type (as in ConnectivityManager.TYPE_*) of currently active
	 * network, or null if there's no active connection.
	 * 
	...
	/**
	 * maximum size, in bytes, of downloads that may go over a mobile
	...
	/**
	 * recommended maximum size, in bytes, of downloads that may go over a
	 * mobile connection; or null if there's no recommended limit. The user will
	 * have the option to bypass this limit.
	 * 
	 ...
	 * @param pckg
	 *            package name
	 * @return Returns true if the specified UID owns the specified package
	 *         name.
